...
<span class="token keyword">LIMIT</span>                    <span class="token number">6</span>
	分页参数
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>DDL语句的执行顺序即为: FROM—》WHERE—》GROUP BY—》SELECT—》ORDER BY—》LIMIT</p>`,2);function o(t,p){return n(),e("div",null,[c,a(" more "),r])}const u=s(d,[["render",o],["__file","1.DDL语句的执行顺序.html.vue"]]);export{u as default};
